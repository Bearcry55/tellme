...
export default function ProposalForm({
  ...
  // Dictionary mapping IDs to readable target labels
  const strategyLabels: Record<string, string> = {
    "pleading-cats-02": "🐱 Pleading Cats Arena",
    "retro-pixel-03": "👾 Retro Arcade Evasion",
    "tamagotchi-pet-04": "🥺 Tamagotchi Virtual Pet",
    "cyberpunk-hack-05": "🔓 Cyberpunk Mainframe",
  };
        ...
        <div className={styles.proposalCard}>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className={styles.formLabel}>Your Signature Name</label>
                <input
                  type="text"
                  required
                  value={senderName}
              ...
              <div>
                <label className={styles.formLabel}>Their Target Name</label>
                <input
                  type="text"
                  required
                  value={receiverName}
            ...
            <div>
              <label className={styles.formLabel}>Custom Question Text</label>
              <input
                type="text"
            ...
            <div>
              <label className={styles.formLabel}>Selected Strategy</label>
              <div className={styles.strategyBox}>
                <span>
                  {strategyLabels[templateId] || "Custom Active Strategy"}
                </span>
